<!-- <template>
  <view>
    <!-- 判断购物侧的商品 如果为空就显示去添加商品 -->
   <!-- <view class="nal" v-if="cartnumber==0?true:''">
     <image src="../../static/nall.png" mode=""></image>
     <navigator url="../goods/goods" open-type="switchTab">去商城逛逛吧</navigator>
    </view>
    <!--  -->
   <!-- <view class="itembox">
